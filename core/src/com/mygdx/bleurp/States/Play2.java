...
import com.mygdx.bleurp.Entity.FlyingBleurp;
 ...
 */
public class Play2 extends State {

    private TiledMap map;
    private OrthogonalTiledMapRenderer renderer;
    public FlyingBleurp player;
        ...
        for(MapObject object : map.getLayers().get("objects").getObjects()){
            if(object instanceof RectangleMapObject){
                ...
                if(((RectangleMapObject)object).getProperties().containsKey("player")){
                    player = new FlyingBleurp(still, left, right,upLeft,upRight,upIdle,(TiledMapTileLayer) map.getLayers().get("Block"));
